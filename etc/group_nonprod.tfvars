...
logs_list = [
  ...
  "/opt/wildfly/logs/global.log",
  "/opt/wildfly/logs/ibs.log",
  "/opt/wildfly/logs/instructor.log",
  "/opt/wildfly/logs/obs-fin-stmt.log",
  "/opt/wildfly/logs/obs.log",
  "/opt/wildfly/logs/pass-plus-pilot.log",
  ...
  "/opt/d90wrapper/logs/axis2.log",
  "/opt/d90wrapper/logs/d90Soap.log",
  "/opt/tomcat/logs/obs-web.log",
  "/opt/tomcat/logs/obs-kpi.log",
  "/opt/tomcat/logs/obs-security.log",
  "/opt/tomcat/logs/DSA-IBS.log",
  "/opt/tomcat/logs/DSA-IBS-CACHE.log",
  "/opt/tomcat/logs/DSA-IBS-SECURITY.log",
  "/opt/tomcat/logs/DSA-IBS-SHORT_NOTICE_SLOT_BOOKINGS.log",
  "/opt/tomcat/logs/DSA-IBS-TARS.log",
  "/opt/tomcat/logs/DSA-IBS-TARS-HANDLED.log",
  "/opt/tomcat/logs/DSA-IBS-TEST-CENTRE-SEARCH.log",
  "/opt/tomcat/logs/DSA-PLACEFINDER.log",
  "/opt/tomcat/logs/PLACEFINDER-PERFORMANCE.log",
