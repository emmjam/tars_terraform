...
wildfly_messaging_id                   = "release_202303"
...
tars_rds_engine_version                     = "19.0.0.0.ru-2022-01.rur-2022-01.r1"  # set to current version, when doing a major upgrade set the engine version for the env tfvars file https://dvsa.atlassian.net/wiki/spaces/TB/pages/119932638/Major+RDS+DB+version+upgrade+and+Terraform
tars_rds_instance_class                     = "db.m5.2xlarge"
...
mis_rds_engine_version          = "19.0.0.0.ru-2022-01.rur-2022-01.r1"   # set to current version, when doing a major upgrade set the engine version for the env tfvars file https://dvsa.atlassian.net/wiki/spaces/TB/pages/119932638/Major+RDS+DB+version+upgrade+and+Terraform
...
rsis_rds_engine_version          = "19.0.0.0.ru-2022-01.rur-2022-01.r1"   # set to current version, when doing a major upgrade set the engine version for the env tfvars file https://dvsa.atlassian.net/wiki/spaces/TB/pages/119932638/Major+RDS+DB+version+upgrade+and+Terraform
...
cpc_rds_engine_version          = "19.0.0.0.ru-2022-01.rur-2022-01.r1"   # set to current version, when doing a major upgrade set the engine version for the env tfvars file https://dvsa.atlassian.net/wiki/spaces/TB/pages/119932638/Major+RDS+DB+version+upgrade+and+Terraform
cpc_rds_instance_class          = "db.r5.xlarge"
cpc_rds_port                    = "1521"
