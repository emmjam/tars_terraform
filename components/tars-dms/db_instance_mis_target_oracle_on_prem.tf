...
resource "aws_db_instance" "target_misdb_dms_on_prem" {
  identifier                = "${local.csi}-misopdmstg"
  final_snapshot_identifier = "${local.csi}-misopdmstg"
  ...
  snapshot_identifier       = "${var.target_dms_on_prem_mis_rds_snapshot}"
