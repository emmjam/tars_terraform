...
data "aws_iam_policy_document" "ssm_parameters" {
  statement {
    ...
    resources = [
      "arn:aws:ssm:${var.aws_region}:${var.aws_account_id}:parameter/${var.environment}/cpc/all/*",
      "arn:aws:ssm:${var.aws_region}:${var.aws_account_id}:parameter/${var.environment}/cpc/batch/*",
      "arn:aws:ssm:${var.aws_region}:${var.aws_account_id}:parameter/${var.environment}/cpc/back/*",
    ]
  }
}
