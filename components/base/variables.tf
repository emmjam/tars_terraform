...
variable "reporting_xe_ami_build_id" {
  description = "XE ami build jenkins job ID"
  type        = string
}

variable "public_domain_name" {
  description = "public domain name FQDN"
  type        = string
}
...
variable "reporting_xe_asg_min_size" {
  type        = number
  description = "reporting xe ASG min size"
}

variable "reporting_xe_asg_max_size" {
  type        = number
  description = "reporting xe ASG max size"
}

variable "reporting_xe_asg_desired_size" {
  type        = number
  description = "reporting xe ASG desired capacity"
}

variable "reporting_xe_subnets_cidrs" {
  type        = list(string)
  description = "Reporting XE subnet CIDR's"
  default     = []
}

variable "reporting_xe_subnet_cidr" {
  type        = list(string)
