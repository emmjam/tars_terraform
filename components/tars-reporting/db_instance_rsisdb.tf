...
resource "aws_db_instance" "rsisdb" {
  ...
  vpc_security_group_ids = [aws_security_group.tars-rsis-db.id, ]
...
resource "aws_db_instance" "rsisdb_encrypted" {
  identifier     = "${local.csi}-rsisdb-encrypted"
  instance_class = var.rsis_rds_instance_class
  license_model  = var.rsis_rds_license_model
  ...
  snapshot_identifier       = var.rsis_rds_encrypted_snapshot
  final_snapshot_identifier = "${local.csi}-rsisdb-encrypted-final"
  skip_final_snapshot       = var.rsis_rds_skip_final_snapshot
